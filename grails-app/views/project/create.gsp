...
<head>
    ...
    <meta name="breadcrumb" content="${message(code: 'breadcrumb.project.create')}"/>
...
<div class="container-fluid validationEngineContainer" id="validation-container">
    <content tag="bannertitle">
        ...
        ${customTitle?:messageSource.getMessage('project.create.register', [].toArray(), '', org.springframework.web.servlet.support.RequestContextUtils.getLocale(request))}
    </content>
    <p>
